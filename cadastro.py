...
def confirmar_cadastro():
    ...
    if not nome or not email or not senha:
        messagebox.showwarning("Campos obrigatorios", "Preencha nome, email e senha.")
        return
...
# Nomeando a janela
janela.title("Cadastro - Finance Manager")
...
frame_cadastro = tk.Frame(janela, bg="black", padx=35, pady=25)
